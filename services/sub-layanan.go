...
type SubLayananService interface {
	CreateSubLayanan(req *requests.SubLayananRequest) (*models.SubLayananDesa, error)
	GetAllSubLayanan(
		layananDesaID uint,
		search string,
		page int,
	...
	GetSubLayananByID(id uint) (*models.SubLayananDesa, error)
	GetSubLayananByLayananID(layananDesaID uint) ([]models.SubLayananDesa, error)
	UpdateSubLayanan(id uint, req *requests.SubLayananRequest) (*models.SubLayananDesa, error)
	DeleteSubLayanan(id uint) error
}

type subLayananService struct {
	repository        repositories.SubLayananRepository
...
func (s *subLayananService) CreateSubLayanan(req *requests.SubLayananRequest) (*models.SubLayananDesa, error) {
	...
	subLayanan := models.SubLayananDesa{
...
func (s *subLayananService) GetSubLayananByID(id uint) (*models.SubLayananDesa, error) {
	return s.repository.FindSubLayananByID(id)
}

func (s *subLayananService) GetSubLayananByLayananID(layananDesaID uint) ([]models.SubLayananDesa, error) {
	return s.repository.FindSubLayananByLayananID(layananDesaID)
}

func (s *subLayananService) UpdateSubLayanan(id uint, req *requests.SubLayananRequest) (*models.SubLayananDesa, error) {
	if err := s.validate.Struct(req); err != nil {
		return nil, err
	}
...
type PengajuanLayananService interface {
	CreatePengajuan(req *requests.PengajuanRequest) (*models.PengajuanLayanan, error)
	GetAllPengajuan(
		search string,
		status string,
		nik string,
	...
	GetPengajuanByID(id uint) (*models.PengajuanLayanan, error)
	GetPengajuanByNIK(nik string) ([]models.PengajuanLayanan, error)
	GetPengajuanByNomorSurat(nomorSurat string) (*models.PengajuanLayanan, error)
	UpdatePengajuan(id uint, req *requests.PengajuanUpdateRequest) (*models.PengajuanLayanan, error)
	UpdateStatusPengajuan(id uint, req *requests.UpdateStatusRequest, updatedBy uint) (*models.PengajuanLayanan, error)
	ApprovePengajuan(id uint, req *requests.ApproveRequest, approvedBy uint) (*models.PengajuanLayanan, error)
	RejectPengajuan(id uint, req *requests.RejectRequest, rejectedBy uint) (*models.PengajuanLayanan, error)
	DeletePengajuan(id uint) error
	GetStatisticsByStatus() (map[string]int64, error)
}

type pengajuanLayananService struct {
	repository         repositories.PengajuanLayananRepository
	layananRepository  repositories.LayananRepository
	subLayananRepo     repositories.SubLayananRepository
	riwayatRepository  repositories.RiwayatPengajuanRepository
	validate           *validator.Validate
}
...
func (s *pengajuanLayananService) CreatePengajuan(req *requests.PengajuanRequest) (*models.PengajuanLayanan, error) {
	if err := s.validate.Struct(req); err != nil {
		return nil, err
	}
	...
	pengajuan := models.PengajuanLayanan{
		LayananDesaID: req.LayananDesaID,
	...
	riwayat := models.RiwayatPengajuan{
...
func (s *pengajuanLayananService) GetPengajuanByID(id uint) (*models.PengajuanLayanan, error) {
	return s.repository.FindPengajuanByID(id)
}

func (s *pengajuanLayananService) GetPengajuanByNIK(nik string) ([]models.PengajuanLayanan, error) {
	return s.repository.FindPengajuanByNIK(nik)
}

func (s *pengajuanLayananService) GetPengajuanByNomorSurat(nomorSurat string) (*models.PengajuanLayanan, error) {
	return s.repository.FindPengajuanByNomorSurat(nomorSurat)
}

func (s *pengajuanLayananService) UpdatePengajuan(id uint, req *requests.PengajuanUpdateRequest) (*models.PengajuanLayanan, error) {
	if err := s.validate.Struct(req); err != nil {
		return nil, err
	}
...
func (s *pengajuanLayananService) UpdateStatusPengajuan(id uint, req *requests.UpdateStatusRequest, updatedBy uint) (*models.PengajuanLayanan, error) {
	if err := s.validate.Struct(req); err != nil {
		return nil, err
	}
...
func (s *pengajuanLayananService) ApprovePengajuan(id uint, req *requests.ApproveRequest, approvedBy uint) (*models.PengajuanLayanan, error) {
	if err := s.validate.Struct(req); err != nil {
		return nil, err
	}
...
func (s *pengajuanLayananService) RejectPengajuan(id uint, req *requests.RejectRequest, rejectedBy uint) (*models.PengajuanLayanan, error) {
	if err := s.validate.Struct(req); err != nil {
		return nil, err
	}
...
type RiwayatPengajuanService interface {
	GetRiwayatByPengajuanID(pengajuanID uint) ([]models.RiwayatPengajuan, error)
	GetAllRiwayat(
		pengajuanID uint,
		page int,
		limit int,
...
type riwayatPengajuanService struct {
	repository repositories.RiwayatPengajuanRepository
}

func NewRiwayatPengajuanService(repository repositories.RiwayatPengajuanRepository) RiwayatPengajuanService {
	return &riwayatPengajuanService{
		repository: repository,
	}
}

func (s *riwayatPengajuanService) GetRiwayatByPengajuanID(pengajuanID uint) ([]models.RiwayatPengajuan, error) {
