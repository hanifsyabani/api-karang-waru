...
func ProfilResponseFromModel(profil *domain.ProfilDesa) ProfilDesaResponse {
...
func DemografisResponseFromModel(profil *domain.Demografis) DemografisResponse {
...
func SejarahResponseFromModel(sejarah *domain.Sejarah) SejarahResponse {
...
func VisiMisiResponseFromModel(visiMisi *domain.VisiMisi) VisiMisiResponse {
