...
import "api-karang-waru/internal/domain"
...
func LembagaPendidikanFromModel(m *domain.LembagaPendidikan) LembagaPendidikanResponse {
...
func StatistikPendidikanFromModel(m *domain.StatistikPendidikan) StatistikPendidikanResponse {
...
func ProgramPendidikanFromModel(m *domain.ProgramPendidikan) ProgramPendidikanResponse {
...
func CapaianPendidikanFromModel(m *domain.CapaianPendidikan) CapaianPendidikanResponse {
...
func DokumentasiPendidikanFromModel(m *domain.DokumentasiPendidikan) DokumentasiPendidikanResponse {
