...
func SubLayananResponseFromModel(model *domain.SubLayananDesa) SubLayananResponse {
...
func PengajuanResponseFromModel(model *domain.PengajuanLayanan) PengajuanResponse {
...
func RiwayatPengajuanResponseFromModel(model *domain.RiwayatPengajuan) RiwayatPengajuanResponse {
