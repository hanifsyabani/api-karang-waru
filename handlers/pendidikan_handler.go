...
func (h *PendidikanHandler) CreateLembaga(c *gin.Context) {
	var req requests.LembagaPendidikanRequest
	...
	c.JSON(http.StatusCreated, responses.APIResponse{
		...
		Data:    responses.LembagaPendidikanFromModel(data),
	})
}
...
func (h *PendidikanHandler) GetAllLembaga(c *gin.Context) {
	...
	var list []responses.LembagaPendidikanResponse
	for _, d := range data {
		list = append(list, responses.LembagaPendidikanFromModel(&d))
	}
...
func (h *PendidikanHandler) CreateStatistik(c *gin.Context) {
	var req requests.StatistikPendidikanRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, responses.APIResponse{
			Code:    "BAD_REQUEST",
			Message: err.Error(),
	...
	c.JSON(http.StatusCreated, responses.APIResponse{
		...
		Data:    responses.StatistikPendidikanFromModel(data),
	})
}
...
func (h *PendidikanHandler) GetAllStatistik(c *gin.Context) {
	...
	var list []responses.StatistikPendidikanResponse
	for _, d := range data {
		list = append(list, responses.StatistikPendidikanFromModel(&d))
	}
...
func (h *PendidikanHandler) CreateProgram(c *gin.Context) {
	var req requests.ProgramPendidikanRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, responses.APIResponse{
			Code:    "BAD_REQUEST",
			Message: err.Error(),
	...
	c.JSON(http.StatusCreated, responses.APIResponse{
		...
		Data:    responses.ProgramPendidikanFromModel(data),
	})
}
...
func (h *PendidikanHandler) GetAllProgram(c *gin.Context) {
	...
	var list []responses.ProgramPendidikanResponse
	for _, d := range data {
		list = append(list, responses.ProgramPendidikanFromModel(&d))
	}
...
func (h *PendidikanHandler) CreateCapaian(c *gin.Context) {
	var req requests.CapaianPendidikanRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, responses.APIResponse{
			Code:    "BAD_REQUEST",
			Message: err.Error(),
	...
	c.JSON(http.StatusCreated, responses.APIResponse{
		...
		Data:    responses.CapaianPendidikanFromModel(data),
	})
}
...
func (h *PendidikanHandler) GetAllCapaian(c *gin.Context) {
	...
	var list []responses.CapaianPendidikanResponse
	for _, d := range data {
		list = append(list, responses.CapaianPendidikanFromModel(&d))
	}
...
func (h *PendidikanHandler) CreateDokumentasi(c *gin.Context) {
	var req requests.DokumentasiPendidikanRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, responses.APIResponse{
			Code:    "BAD_REQUEST",
			Message: err.Error(),
	...
	c.JSON(http.StatusCreated, responses.APIResponse{
		...
		Data:    responses.DokumentasiPendidikanFromModel(data),
	})
}
...
func (h *PendidikanHandler) GetAllDokumentasi(c *gin.Context) {
	...
	var list []responses.DokumentasiPendidikanResponse
	for _, d := range data {
		list = append(list, responses.DokumentasiPendidikanFromModel(&d))
	}
